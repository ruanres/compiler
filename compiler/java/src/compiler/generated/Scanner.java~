...
class Scanner {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\11\0\1\2\1\2\1\3\1\2\1\2\22\0\1\2\17\0\12\1"+
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 5: break;
          case 2: 
            { System.out.println(String.format("Found the number %s at line %d, column %d, char %d", yytext(), yyline, yycolumn, yychar));
            }
          case 6: break;
          case 3: 
            { /* ignore white space. */
